...
|---|---|---|---|
| Battle 2D pool, supplied original cell renderer and impact continuation | `battleEffectActors.js`, `battleNativeLaunch.js`, `battleEffectArt.js`, `battleEffectSprites.js` | [R12](art/production/battle-effect-r12/IMPLEMENTATION_2026-09-08.md):151 banks,484 native sequence bindings,1231 original cells,exact supplied RGBA/origins,118/118 normal browser instances released,1244 regression passes; R11 arithmetic remains unchanged | Reuse the existing native pool, timeline, actor layer and local reference atlas. Generated R11 pictures are retired. Original cells are loopback research only and excluded from public builds. Full3D/audio and all-move/device QA remain partial |
| Battle native math and compound motion | `battleRemainingNatives.js`, `battleNativeMath.js`, `battleNativeMemory.js` | All 67 body registrations, 1,872 controlled CPU frames and integer math oracle; [R6 report](art/production/battle-native-motion-r6/IMPLEMENTATION_2026-09-07.md) | Bounded integration: do not equate bodies or the two controlled motion fixtures with a complete normal attack, effect pool or Home party |
