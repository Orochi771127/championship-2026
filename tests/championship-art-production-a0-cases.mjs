...
test("production index registers the licensed Hunt, Cage, Battle, and VFX pilots without shipping them", () => {
  ...
  for (const entry of index.entries) {
    ...
    if (['art:vfx:battle-effects:local-reference:v1','art:audio:battle:local-reference:v1','art:vfx:raising-feedback:local-reference:v1','art:characters:hud:local-reference:v1','art:vfx:hunt-feedback:local-reference:v1','art:ui:assembled:local-reference:v1'].includes(entry.assetId)) {
